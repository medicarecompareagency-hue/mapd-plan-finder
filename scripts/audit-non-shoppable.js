...
// Enum values must match prisma/schema.prisma exactly — note MA_ONLY (with
// underscore), not 'MA' which is what the original 04-30 backlog item flagged.
const CATEGORY_SIG = {
  PDP:     'PDP_DRUG_NULLS',
  MAPD:    'COST_SHARING_5', // already cleaned 04-27, sanity check should return 0
  MA_ONLY: 'COST_SHARING_5',
  MMP:     'COST_SHARING_5',
  COST:    'COST_SHARING_5',
};
